...
parser.add_argument('--save', type=str, default='frontface', help='save folder in face2face')
...
def get_data():
    if args.task_name == 'car2car':
    ...
    elif args.task_name == 'face2face': #change
        ...
        data_A = get_chairs( test=False, half='first', ver=360 ) #first= anyangle
        data_B = get_chairs( test=False, half='last', ver=360 ) #last = front
...
def main():
    ...
    for epoch in range(epoch_size):
        #data_style_A, data_style_B = shuffle_data(data_style_A, data_style_B) # change or A : any orientation except front B : front
